...
cp -aL ${SYSROOT}/lib64/ld-2.31.so ${OUTDIR}/rootfs/lib/ld-2.31.so
...
#ls -l ${SYSROOT}/lib64/libm.so.6
#ls -l ${SYSROOT}/lib64/libresolv.so.2
#ls -l ${SYSROOT}/lib64/libc.so.6
# ${SYSROOT}/lib64/libm.so.6 -> libm-2.31.so
# ${SYSROOT}/lib64/libresolv.so.2 -> libresolv-2.31.so
# ${SYSROOT}/lib64/libc.so.6 -> libc-2.31.so
cp -aL ${SYSROOT}/lib64/libm-2.31.so ${OUTDIR}/rootfs/lib64/libm-2.31.so
cp -aL ${SYSROOT}/lib64/libresolv-2.31.so ${OUTDIR}/rootfs/lib64/libresolv-2.31.so
cp -aL ${SYSROOT}/lib64/libc-2.31.so ${OUTDIR}/rootfs/lib64/libc-2.31.so
